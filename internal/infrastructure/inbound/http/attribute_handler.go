...
func toOptionInput(opt httpapi.AttributeOptionInput, _ int) attribute.OptionInput {
	return attribute.OptionInput{
		Name:      opt.Name,
		Slug:      opt.Slug,
...
func (h *attributeHandler) GetAttributeById(ctx context.Context, params httpapi.GetAttributeByIdParams) (httpapi.GetAttributeByIdRes, error) { //nolint:revive // name from OpenAPI spec
	q := attribute.GetAttributeByIDQuery{ID: params.ID.String()}
