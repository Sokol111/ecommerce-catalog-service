...
func (_mock *MockRepository) FindByID(ctx context.Context, id string) (*Attribute, error) {
	ret := _mock.Called(ctx, id)
...
func (_c *MockRepository_FindByID_Call) RunAndReturn(run func(ctx context.Context, id string) (*Attribute, error)) *MockRepository_FindByID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockRepository_FindByIDs_Call) Return(attributes []*Attribute, err error) *MockRepository_FindByIDs_Call {
	_c.Call.Return(attributes, err)
	return _c
}

func (_c *MockRepository_FindByIDs_Call) RunAndReturn(run func(ctx context.Context, ids []string) ([]*Attribute, error)) *MockRepository_FindByIDs_Call {
	_c.Call.Return(run)
	return _c
}

// FindByIDsOrFail provides a mock function for the type MockRepository
func (_mock *MockRepository) FindByIDsOrFail(ctx context.Context, ids []string) ([]*Attribute, error) {
	ret := _mock.Called(ctx, ids)
...
func (_c *MockRepository_FindByIDsOrFail_Call) Return(attributes []*Attribute, err error) *MockRepository_FindByIDsOrFail_Call {
	_c.Call.Return(attributes, err)
	return _c
}

func (_c *MockRepository_FindByIDsOrFail_Call) RunAndReturn(run func(ctx context.Context, ids []string) ([]*Attribute, error)) *MockRepository_FindByIDsOrFail_Call {
	_c.Call.Return(run)
	return _c
}
