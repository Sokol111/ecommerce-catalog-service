...
type UpdateCategoryCommandHandler interface {
	Handle(ctx context.Context, cmd UpdateCategoryCommand) (*Category, error)
}
...
func (h *updateCategoryHandler) Handle(ctx context.Context, cmd UpdateCategoryCommand) (*Category, error) {
